...
const home = (props) => {
  ...
  console.log('dataa in coaches detail', data);
  return (
    <View style={{ flex: 1 }}>
      <Header
      ...
      <View style={styles.forum}>
        <View>
          <View style={[styles.imgContainer, data.image == null && {
            overflow: 'hidden',
            padding: 20,
          }]}>
            <Image
        ...
        <View style={styles.text}>
          ...
          <Text style={styles.members}>{data.business_name.split(' ').slice(0,2).join(' ')}</Text>
      ...
      <TouchableOpacity
        onPress={() => props.navigation.navigate('webview', { uri: 'https://form.jotform.com/201324104586043' })}
